...
| Configuração | IA lista eventos? | IA cria eventos? | IA vê sua agenda pessoal? |
|---|---|---|---|
...
<Aside type="caution">
  Se você apagar a agenda dedicada direto pelo Google Calendar, o ThairaAI ainda tem o ID guardado. Clique em **Limpar** no painel antes de criar uma nova, ou use o dropdown **ou escolher existente…** para revincular.
</Aside>
